...
namespace Bridge24_2._0
{
    ...
    { 
        ...
        const double bidding_szerokosckolumny = 2;
        ...
        public Treprinter (BBOGameReader game_)
        {
            game = game_;
        ...
        private Row CreateBidding_Surname(Row row)
        {
            ...
            row.Cells[1].AddParagraph(game.nazwiska_[1]);
            row.Cells[2].AddParagraph(game.nazwiska_[0]);
            row.Cells[3].AddParagraph(game.nazwiska_[3]);
            /*
   ...
   /*         
        ...
        private void WriteLineKontrakt(InfoBoard board)
        {
            Section section = document.LastSection;
        ...
        private void WriteCommentTitle()
        {
            ...
            komentarze.AddFormattedText("NOWE USTALENIA :");
           /* komentarze.AddLineBreak(); komentarze.AddLineBreak();
            komentarze.AddLineBreak(); komentarze.AddLineBreak(); komentarze.AddLineBreak();
