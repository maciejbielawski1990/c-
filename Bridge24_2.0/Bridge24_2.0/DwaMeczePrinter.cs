...
namespace Bridge24_2._0
{
    public class DwaMeczePrinter
    {
        ...
        const double bidding_szerokosckolumny = 0.85;
        ...
        private void PageSettings(Section section)
        {
            ...
            naglowek.AddSpace(17);
           // naglowek.AddFormattedText(v.data.ToShortDateString());
        ...
        private void CreateBidding(int nr)
        {
            ...
            idx = 1;
            int wiersz = 1;
            while (vugraph1.licytacja_open[nr][idx] != null)
            {
                ...
                p = WriteOdzywka(p, vugraph1.licytacja_open[nr][idx]);
            ...
            idx = 1;
            wiersz = 1;
            while (vugraph1.licytacja_closed[nr][idx] != null)
            {
                int tmp = (idx - 1 + nr) / 4 + 3;
                if ((idx - 1 + nr) % 4 == 0 || idx == 1)
                    wiersz++;
                ...
                p = WriteOdzywka(p, vugraph1.licytacja_closed[nr][idx]);
            ...
            */
            ...
            idx = 1;
             wiersz = 1;
            while (vugraph2.licytacja_open[nr][idx] != null)
            {
                int tmp = (idx - 1 + nr) / 4 + 3;
                if ((idx - 1 + nr) % 4 == 0 || idx == 1)
                    wiersz++;
                ...
                row = table.Rows[wiersz];
                Paragraph p = row[((idx - 1 + nr) % 4) + 6].AddParagraph();
                p = WriteOdzywka(p, vugraph2.licytacja_open[nr][idx]);
            ...
            idx = 1;
            wiersz = 1;
            while (vugraph2.licytacja_closed[nr][idx] != null)
            {
                int tmp = (idx - 1 + nr) / 4 + 3;
                if ((idx - 1 + nr) % 4 == 0 || idx == 1)
                    wiersz++;
                ...
                row = table.Rows[wiersz];
                Paragraph p = row[((idx - 1 + nr) % 4) + 12].AddParagraph();
                p = WriteOdzywka(p, vugraph2.licytacja_closed[nr][idx]);
        ...
        private Row CreateBidding_FirstRow(Row row)
        {
            ...
            //closed room
            row.Cells[18].AddParagraph("N");
            row.Cells[19].AddParagraph("E");
            row.Cells[20].AddParagraph("S");
            row.Cells[21].AddParagraph("W");
        ...
        private Row CreateBidding_Surname(Row row)
        {
            ...
            row.Cells[2].AddParagraph(vugraph1.nazwiska_[0]);
            row.Cells[3].AddParagraph(vugraph1.nazwiska_[1]);
            row.Cells[0].AddParagraph(vugraph1.nazwiska_[2]);
            row.Cells[1].AddParagraph(vugraph1.nazwiska_[3]);

            //wydrik nazwisk pokoj zamkniety
            row.Cells[6].AddParagraph(vugraph1.nazwiska_[4].ToString());
            row.Cells[7].AddParagraph(vugraph1.nazwiska_[5].ToString());
            row.Cells[8].AddParagraph(vugraph1.nazwiska_[6].ToString());
            row.Cells[9].AddParagraph(vugraph1.nazwiska_[7].ToString());

            //wydruk nazwisk pokoj otwarty

            row.Cells[12].AddParagraph(vugraph1.nazwiska_[0]);
            row.Cells[13].AddParagraph(vugraph1.nazwiska_[1]);
            row.Cells[14].AddParagraph(vugraph1.nazwiska_[2]);
            row.Cells[15].AddParagraph(vugraph1.nazwiska_[3]);

            //wydrik nazwisk pokoj zamkniety
            row.Cells[18].AddParagraph(vugraph2.nazwiska_[4].ToString());
            row.Cells[19].AddParagraph(vugraph2.nazwiska_[5].ToString());
            row.Cells[20].AddParagraph(vugraph2.nazwiska_[6].ToString());
            row.Cells[21].AddParagraph(vugraph2.nazwiska_[7].ToString());
